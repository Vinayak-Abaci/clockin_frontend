	...
	const cards: StatCardConfig[] = [
		{
			...
			tooltip: 'Employees who have met today\'s minimum required working hours and are marked as Present.',
		},
		{
			label: 'Absent',
			value: absent,
			...
			tooltip: 'Employees who haven\'t met today\'s minimum required working hours and are marked as Absent.',
		},
		{
			label: 'On leave',
			value: leave,
			...
			tooltip: 'Employees approved for leave today.',
		},
		{
			label: 'Clocked in',
			...
			tooltip: 'Employees whose current attendance status is Clocked In.',
		},
		{
			label: 'Clocked out',
			...
			tooltip: 'Employees whose current attendance status is Clocked Out.',
		},
	];
